...
public class LogManager {
     ...
     * Logger#setLevel(Level) set} to the specified log level.
     * <p>
     * To properly update the logging configuration, use the
     * {@link #updateConfiguration(Function)} or
     * {@link #updateConfiguration(InputStream, Function)}
     * methods instead.
     *
     ...
     * #getProperty(String) properties}. The {@link
     ...
     *
     * @see #updateConfiguration(InputStream, Function)
     * @since 9
     */
     ...
     * #getProperty(String) existing configuration} and
     ...
     * <i>n</i>.
     * <p>
     * LogManager {@linkplain #getProperty(String) properties} are
     ...
     * {@link #readConfiguration()} (or {@link #readConfiguration(InputStream)})
     ...
     * exceptions as {@linkplain Throwable#addSuppressed(Throwable)
